...
<div class="container-fluid mainCon">
        ...
        $q="SELECT * FROM customer c,profileview p WHERE c.`email`=p.`viewedby` AND p.`viewed`='$email' and interest!='0'";
        ...
        while ($r= mysqli_fetch_array($s))
        {
            ?>
                        ...
                        <?php
                            ...
                            if($r['interest']==1){
                            echo"
                            <input class='btn-success' type='submit' name='submit' value='Accept'></input>";
                            }else{
                                echo"
...
{
    $semail=$_POST['semail'];
    $sql="update profileview set interest='2' where viewedby='$semail' and viewed='$email'";
