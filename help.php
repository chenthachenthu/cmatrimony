...
<?php
        ...
        $q="SELECT * FROM chat WHERE sender='$email' AND receiver='admin@gmail.com' OR receiver='$email' AND sender='admin@gmail.com' ORDER BY `chatid`";
...
<div class='containerchat darker'>
  <img src='images\p1.jpg' alt='Avatar' class='right'>
  <p><p>$r[message]</p></p>
</div>
";
    }
...
if (isset($_POST['submit'])){
  ...
  $sql="INSERT INTO `chat` (`sender`,`receiver`,`message`,`date`) VALUES('$email','admin@gmail.com','$msg',(select sysdate()))";
   echo $sql;
